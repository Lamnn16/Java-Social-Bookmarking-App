package com.lamnn.thrillio;

import com.lamnn.thrillio.constants.BookGenre;
import com.lamnn.thrillio.constants.Gender;
import com.lamnn.thrillio.constants.MovieGenre;
import com.lamnn.thrillio.constants.UserType;
import com.lamnn.thrillio.entities.Bookmark;
import com.lamnn.thrillio.entities.User;
import com.lamnn.thrillio.entities.UserBookmark;
import com.lamnn.thrillio.managers.BookmarkManager;
import com.lamnn.thrillio.managers.UserManager;

public class DataStore {
	private static final int USER_BOOK_MARK_LIMIT = 5;
	...
	private static UserBookmark[] userBookmarks = new UserBookmark[TOTAL_USER_COUNT * USER_BOOK_MARK_LIMIT];
	...
	private static void loadMovies() {
		...
		bookmarks[1][2] = BookmarkManager.getInstance().createMovie(3002, "A Touch of Greatness", "", 2004,
				new String[] { "Albert Cullum" }, new String[] { "Sullivan" }, MovieGenre.DOCUMENTARIES, 7.3);
